<?php
class BernouliModel__ extends Database
{
   private $db;
   ...
   public function cekBernouli_Stem_Stop($kata)
   {
      $this->db->query("SELECT kata_unik, bobot_cyberbullying, bobot_non_cyberbullying FROM conditional_stem_stop_bernouli WHERE kata_unik = :kata_unik");
      $this->db->bind('kata_unik', $kata);
      return $this->db->single();
   }

   public function cekBernouli_Stem($kata)
   {
      $this->db->query("SELECT kata_unik, bobot_cyberbullying, bobot_non_cyberbullying FROM conditional_stem_bernouli WHERE kata_unik = :kata_unik");
      $this->db->bind('kata_unik', $kata);
      return $this->db->single();
   }

   public function cekBernouli_Stop($kata)
   {
      $this->db->query("SELECT kata_unik, bobot_cyberbullying, bobot_non_cyberbullying FROM conditional_stop_bernouli WHERE kata_unik = :kata_unik");
      $this->db->bind('kata_unik', $kata);
      return $this->db->single();
   }
   ...
   {
      $this->db->query("SELECT kata_unik, bobot_cyberbullying, bobot_non_cyberbullying FROM conditional_bernouli WHERE kata_unik = :kata_unik");
      $this->db->bind('kata_unik', $kata);
      return $this->db->single();
   }


   public function tambahConditionalBernouli_Stem_Stop($hasil)
   {
      $query = "INSERT INTO conditional_stem_stop_bernouli(kata_unik,bobot_cyberbullying, bobot_non_cyberbullying)
   ...
   public function tambahConditionalBernouli_Stem($hasil)
   {
      $query = "INSERT INTO conditional_stem_bernouli(kata_unik,bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:kata_unik, :bobot_cyberbullying, :bobot_non_cyberbullying)";
      $this->db->query($query);
      $this->db->bind('kata_unik', $hasil['kata']);
      $this->db->bind('bobot_cyberbullying', $hasil['cyberbullying']);
   ...
   public function tambahConditionalBernouli_Stop($hasil)
   {
      $query = "INSERT INTO conditional_stop_bernouli(kata_unik,bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:kata_unik, :bobot_cyberbullying, :bobot_non_cyberbullying)";
      $this->db->query($query);
      $this->db->bind('kata_unik', $hasil['kata']);
      $this->db->bind('bobot_cyberbullying', $hasil['cyberbullying']);
   ...
   {
      $query = "INSERT INTO conditional_bernouli(kata_unik,bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:kata_unik, :bobot_cyberbullying, :bobot_non_cyberbullying)";
      $this->db->query($query);
      $this->db->bind('kata_unik', $hasil['kata']);
      $this->db->bind('bobot_cyberbullying', $hasil['cyberbullying']);
   ...
   {
      $query = "INSERT INTO dt_testing_stem_stop_bernouli(komentar, jenis_komentar, bobot_cyberbullying, bobot_non_cyberbullying)
   ...
   {
      $query = "INSERT INTO dt_testing_stem_bernouli(komentar, jenis_komentar, bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:komentar, :jenis_komentar, :bobot_cyberbullying, :bobot_non_cyberbullying)";
     $this->db->query($query);
      $this->db->bind('komentar', $kata);
      $this->db->bind('jenis_komentar', $penentuanKelas['klasifikasi']);
   ...
   {
      $query = "INSERT INTO dt_testing_stop_bernouli(komentar, jenis_komentar, bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:komentar, :jenis_komentar, :bobot_cyberbullying, :bobot_non_cyberbullying)";
     $this->db->query($query);
      $this->db->bind('komentar', $kata);
      $this->db->bind('jenis_komentar', $penentuanKelas['klasifikasi']);
   ...
   {
      $query = "INSERT INTO dt_testing_bernouli(komentar, jenis_komentar, bobot_cyberbullying, bobot_non_cyberbullying)
         VALUES(:komentar, :jenis_komentar, :bobot_cyberbullying, :bobot_non_cyberbullying)";
     $this->db->query($query);
      $this->db->bind('komentar', $kata);
      $this->db->bind('jenis_komentar', $penentuanKelas['klasifikasi']);
   ...
   {
      $query = "INSERT INTO kom_testing_stem_stop_bernouli(komentar, jenis_komentar)
   ...
   {
      $query = "INSERT INTO kom_testing_stem_bernouli(komentar, jenis_komentar)
         VALUES(:komentar, :jenis_komentar)";
     $this->db->query($query);
      $this->db->bind('komentar', $komentar);
      $this->db->bind('jenis_komentar', $kelas);
   ...
   {
      $query = "INSERT INTO kom_testing_stop_bernouli(komentar, jenis_komentar)
         VALUES(:komentar, :jenis_komentar)";
     $this->db->query($query);
      $this->db->bind('komentar', $komentar);
      $this->db->bind('jenis_komentar', $kelas);
   ...
   {
      $query = "INSERT INTO kom_testing_bernouli(komentar, jenis_komentar)
         VALUES(:komentar, :jenis_komentar)";
     $this->db->query($query);
      $this->db->bind('komentar', $komentar);
      $this->db->bind('jenis_komentar', $kelas);
